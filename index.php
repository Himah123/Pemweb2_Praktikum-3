        ...
        <div class="col-md-12">
            <form action="hasil_nilai.php" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <select id="matakuliah" name="matakuliah" class="custom-select" requured >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <input id="uts" name="uts" placeholder="Nilai UTS" type="text" class="form-control" requured >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="uas" class="col-4 col-form-label">Nilai UAS</label>
                    <div class="col-8">
                        <input id="uas" name="uas" placeholder="Nilai UAS" type="text" class="form-control" requured >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="tugas" class="col-4 col-form-label">Nilai Tugas</label>
                    <div class="col-8"> 
                        <input id="tugas" name="tugas" placeholder="Nilai Tugas" type="text" class="form-control" requured >
                    </div>
                </div>
                <div class="form-group row">
